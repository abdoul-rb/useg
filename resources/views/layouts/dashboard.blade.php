                                    ...
                                    <ul role="list" class="-mx-2 space-y-1">
                                        <li>
                                            <a href="{{ route('dashboard.index') }}"
                                                class="text-gray-400 hover:text-white hover:bg-gray-800 group flex gap-x-3 rounded-md p-2 text-sm leading-6 font-semibold {{ request()->routeIs('dashboard.index') ? 'bg-gray-800 text-white' : '' }}">
                                        ...
                                        <li>
                                            <a href="{{ route('dashboard.events.index') }}"
                                                class="text-gray-400 hover:text-white hover:bg-gray-800 group flex gap-x-3 rounded-md p-2 text-sm leading-6 font-semibold {{ request()->routeIs('dashboard.events.*') ? 'bg-gray-800 text-white' : '' }}">
                                                <svg class="h-6 w-6 shrink-0" fill="none" viewBox="0 0 24 24"
                                                    stroke-width="1.5" stroke="currentColor" aria-hidden="true">
                                                    <path stroke-linecap="round" stroke-linejoin="round"
            ...
            <div class="flex grow flex-col gap-y-5 overflow-y-auto bg-gray-900 px-6 pb-4">
                ...
                <nav class="flex flex-1 flex-col">
                    <ul role="list" class="flex flex-1 flex-col gap-y-7">
                        ...
                        <li class="mt-auto">
                            <a href="{{ route('dashboard.profile.index') }}"
                                class="group -mx-2 flex gap-x-3 rounded-md p-2 text-sm font-semibold leading-6 text-gray-400 hover:bg-gray-800 hover:text-white {{ request()->routeIs('dashboard.profile.index') ? 'bg-gray-800 text-white' : '' }}">
            ...
            <div
                ...
                <div class="flex flex-1 gap-x-4 self-stretch lg:gap-x-6">
                    ...
                    <div class="flex items-center gap-x-4 lg:gap-x-6">
                        ...
                        <!-- Profile dropdown -->
                        <div x-data="{ openDropdown: false }" @keydown.escape.stop="openDropdown = false;"
                            @click.away="onClickAway($event)" class="relative">
                            <button type="button" class="-m-1.5 flex items-center p-1.5" id="user-menu-button"
                                x-ref="button" @click="openDropdown = !openDropdown" aria-expanded="false"
                                aria-haspopup="true">
                                <span class="sr-only">Open user menu</span>
                                <img class="h-8 w-8 rounded-full bg-gray-50" src="{{ auth()->user()->avatar }}"
                            ...
                            <div x-show="openDropdown"
                                ...
                                <a href="{{ route('dashboard.profile.index') }}"
                                    ...
                                    x-state:on="Active" x-state:off="Not Active" role="menuitem" tabindex="-1"
                                    id="user-menu-item-0" @click="openDropdown = false;">
                                    Mon compte
                                </a>
                                <div class="block px-3 py-1 text-sm leading-6 text-gray-900 hover:bg-gray-100"
                                    role="menuitem" tabindex="-1">
                                    <a href="{{ route('auth.logout') }}" class=""
