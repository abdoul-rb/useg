...
@section('content')
    <main>
        <div class="bg-gray-900 relative py-28 sm:py-32 ">
            <div class="blur-[138px] absolute inset-0 m-auto max-w-7xl h-[230px]"
            ...
            <div class="relative">
                <section>
                    <div
                        class="max-w-7xl mx-auto px-8 sm:px-0 items-center gap-12 text-gray-600 flex flex-col sm:justify-center sm:text-center xl:flex-row xl:text-left">
                        <div class="flex-none space-y-5 max-w-4xl xl:max-w-2xl">
                            <h1 class="text-3xl text-white font-bold sm:text-5xl">
                                {{ __("Faciliter l'accès à l'éducation pour tous en Guinée") }}
                            </h1>
                            ...
                            <div class="items-center gap-x-3 font-medium text-sm flex sm:justify-center xl:justify-start">
                                <a href="/#programmes"
                                    class="py-2.5 px-4 text-center rounded-lg duration-150 block text-white bg-sky-500 hover:bg-sky-600 active:bg-sky-700">
                                    Nos programmes
                                </a>
                                <a href="/#about-us"
                                    class="py-2.5 px-4 text-center rounded-lg duration-150 block text-gray-100 bg-gray-700 hover:bg-gray-800">
                                    En savoir plus
                                </a>
                            </div>
                        </div>
        ...
        <!-- About Section -->
        @include('partials.__about')

        <!-- Stats Section -->
        @include('partials.__stats')

        <!-- Programs Section -->
        @include('partials.__programs')

        <!-- Impact Section -->
        @include('partials.__impact')

        <!-- Donation Section -->
        @include('partials.__donation')
        ...
        <section id="about-us" class="py-16 sm:py-28 bg-gray-50 sm:my-16">
            <div class="max-w-7xl mx-auto px-8 text-gray-600 ">
                <div class="max-w-3xl space-y-3">
                    ...
                    <p>
                        Chaque image raconte une histoire de progrès, d'espoir et de détermination. Ensemble, nous faisons
                        la différence. Explorez nos actions concrètes et rejoignez-nous dans notre mission continue pour une
                        éducation épanouissante.
                    </p>
                </div>
                <div class="mt-12">
                    <ul class="grid gap-y-8 gap-x-12 sm:grid-cols-2 lg:grid-cols-3">
                        <li class="flex gap-x-4">
                            <div
                                class="flex-none w-12 h-12 bg-white  border  text-blue-600  rounded-lg flex items-center justify-center">
                            ...
                            <div>
                                ...
                                <p class="">
                                    Défendre l'intérêt général des élèves et étudiants et veiller à l'amélioration des
                                    conditions d'étude
                                </p>
                            </div>
                        </li>
                        <li class="flex gap-x-4">
                            ...
                            <div>
                                <p class="">
                                    Assurer l'accès de tous à une éducation de qualité et de promouvoir l'apprentissage tout
                                    au long de la vie
                                </p>
                            </div>
                        </li>
                        <li class="flex gap-x-4">
                            ...
                            <div>
                                <p class="">
                                    Défendre les intérêts moraux et matériels, tant collectifs qu'individuels, actuel et
                        ...
                        <li class="flex gap-x-4">
                            <div
                                ...
                                <svg viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" class="w-6 h-6">
                                    <path
                                        d="M14.8204 4.26001C14.6218 4.6157 14.4448 4.98303 14.2904 5.36001C12.7732 5.12006 11.2276 5.12006 9.71041 5.36001C9.556 4.98303 9.37901 4.6157 9.18041 4.26001C7.75119 4.50421 6.36181 4.94155 5.05041 5.56001C2.70535 8.9443 1.64184 13.053 2.05041 17.15C3.57864 18.2989 5.29386 19.1751 7.12041 19.74C7.53632 19.1906 7.90751 18.6087 8.2304 18C7.63448 17.7803 7.0617 17.5023 6.52041 17.17C6.66887 17.0712 6.8093 16.9609 6.94041 16.84C8.51887 17.6003 10.2484 17.9952 12.0004 17.9952C13.7524 17.9952 15.4819 17.6003 17.0604 16.84C17.2004 16.96 17.3404 17.07 17.4804 17.17C16.9362 17.4997 16.364 17.7807 15.7704 18.01C16.0799 18.6325 16.4412 19.228 16.8504 19.79C18.6747 19.227 20.3869 18.3506 21.9104 17.2C22.3288 13.1022 21.2644 8.99019 18.9104 5.61001C17.6137 4.97875 16.2381 4.52468 14.8204 4.26001ZM8.68041 14.81C8.17999 14.7741 7.71295 14.5457 7.37733 14.1728C7.0417 13.7999 6.8636 13.3114 6.88041 12.81C6.86107 12.3079 7.03829 11.8181 7.37442 11.4446C7.71054 11.0711 8.17907 10.8435 8.68041 10.81C9.18175 10.8435 9.65027 11.0711 9.98639 11.4446C10.3225 11.8181 10.4997 12.3079 10.4804 12.81C10.4997 13.3121 10.3225 13.8019 9.98639 14.1754C9.65027 14.5489 9.18175 14.7765 8.68041 14.81ZM15.3204 14.81C14.82 14.7741 14.3529 14.5457 14.0173 14.1728C13.6817 13.7999 13.5036 13.3114 13.5204 12.81C13.5011 12.3079 13.6783 11.8181 14.0144 11.4446C14.3505 11.0711 14.8191 10.8435 15.3204 10.81C15.8227 10.841 16.2927 11.0679 16.6294 11.442C16.966 11.816 17.1423 12.3073 17.1204 12.81C17.1423 13.3128 16.966 13.804 16.6294 14.1781C16.2927 14.5521 15.8227 14.779 15.3204 14.81Z"
                                        fill="currentColor"></path>
                                </svg>
                            </div>
                            <div>
                                <p class="">
                                    Recueillir et reverser des fonds et des biens dans le cadre de son objes pour soutenir
            ...
            <div class="max-w-7xl mx-auto px-8 text-gray-600">
                <div class="md:flex md:items-end md:justify-between">
                    <div class="max-w-3xl space-y-3">
                        ...
                        <p>
                            Chaque événement est une célébration de l'éducation, de la solidarité, et de l'avenir prometteur
                            ...
                            <li>
                                <div class="space-y-2 sm:max-w-sm">
                                    <a href="#">
                                        <picture>
                                            <img src="{{ $event->featured_image }}"
                                                class="rounded-lg w-full h-56 object-cover" alt="{{ $event->title }}"
                                                loading="lazy" width="280px" height="300px">
                                        </picture>
                                    </a>
                                    <div class="pt-2 text-sm flex items-center justify-between">
                                        ...
                                        <span
                                            class="text-xs text-gray-700 font-semibold">{{ formatDate($event->date) }}</span>
                                    </div>
