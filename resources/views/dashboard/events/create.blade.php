...
@section('title', 'Ajout d\'un événement')
    ...
    <div class="space-y-10 divide-y divide-gray-900/10">
        <div class="grid grid-cols-1 gap-x-8 gap-y-8 md:grid-cols-3">
            <div class="px-4 sm:px-0">
                <h2 class="text-base font-semibold leading-7 text-gray-900">Ajout d'un nouvel événement</h2>
                <p class="mt-1 text-sm leading-6 text-gray-600">Créer des événement ici et rendez les visible sur votre page</p>
            </div>
    
            <form action="{{ route('dashboard.events.store') }}" class="bg-white shadow-sm ring-1 ring-gray-900/5 sm:rounded-xl md:col-span-2" method="POST" enctype="multipart/form-data">
                @csrf
                ...
                <div class="px-4 py-6 sm:p-8">
                    <div class="grid max-w-2xl grid-cols-1 gap-x-4 gap-y-8 sm:grid-cols-6">
                        <div class="sm:col-span-4">
                            ...
                            <div class="mt-2">
                                <input type="text" name="title" id="title" value="{{ old('title') }}" autocomplete="given-title" class="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-gray-800 sm:text-sm sm:leading-6">
                            </div>
                        </div>
                        ...
                        <div class="sm:col-span-2">
                            ...
                            <div class="mt-2">
                                <input type="date" name="date" id="date" value="{{ old('date') }}" autocomplete="family-name" class="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-gray-800 sm:text-sm sm:leading-6">
                            </div>
                        </div>
